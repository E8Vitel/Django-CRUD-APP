...
from .views import create_producto, view_login, view_historial, view_productos, view_create_productos, view_create_existing_productos, view_productos_output, view_units
urlpatterns = [
